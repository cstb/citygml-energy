...
## Guidelines
A document which describes the guidelines can be downloaded from [this link](https://github.com/cstb/citygml-energy/raw/master/guidelines/Guidelines_EnergyADE.pdf).
